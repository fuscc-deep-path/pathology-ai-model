...
@click.option('--root-dir', '-r', required=True, help="The root directory which to save result files.", type=click.Path(exists=True, dir_okay=True))
@click.option('--model-type', '-m', required=False, help="The model type for prediction (default: PIK3CA_Mutation).", default='PIK3CA_Mutation', type=click.Choice(['PIK3CA_Mutation', 'BLIS', 'IM', 'LAR',  'MES']))
